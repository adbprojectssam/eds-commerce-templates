...
import { isEnabled, filterGatedLinks } from '../../scripts/tier.js';
...
export default async function decorate(block) {
  ...
  // Strip any authored nav links (store locator, addresses, SSO, returns, ...)
  // that belong to a feature not enabled at the current tier. See tier-features.json.
  if (navSections) await filterGatedLinks(navSections);
  ...
  if (await isEnabled('wishlist')) navTools.append(wishlist);
