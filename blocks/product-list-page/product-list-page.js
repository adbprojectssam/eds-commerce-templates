...
import { isEnabled } from '../../scripts/tier.js';
...
export default async function decorate(block) {
  ...
  // Faceted Filters is a Medium+ tier feature (tier-features.json) — Base/Simple
  // tier sites get search results without the facets sidebar.
  const facetsEnabled = await isEnabled('facets');
  if (!facetsEnabled) {
    $viewFacets.remove();
    $facets.remove();
  }
